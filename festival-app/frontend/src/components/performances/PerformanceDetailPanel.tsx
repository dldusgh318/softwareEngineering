...
export default function PerformanceDetailPanel({ performance }: PerformanceDetailPanelProps) {
  return (
    <section className="rounded-2xl border border-white/14 bg-white/10 p-5 shadow-2xl shadow-black/10 backdrop-blur sm:p-6">
      ...
      <dl className="mt-6 grid gap-3 sm:grid-cols-3">
        <div className="rounded-xl border border-white/12 bg-black/12 p-4">
